...
/*can-attribute-encoder@0.2.0#can-attribute-encoder*/
define('can-attribute-encoder', [
    ...
    encoder.decode = function (name) {
        var decoded = name;
        decoded = decoded.replace(delimiters.replaceLeftParens, '(').replace(delimiters.replaceRightParens, ')').replace(delimiters.replaceLeftBrace, '{').replace(delimiters.replaceRightBrace, '}').replace(delimiters.replaceForwardSlash, '/').replace(delimiters.replaceSpace, ' ').replace(delimiters.replaceCaret, '^').replace(delimiters.replaceDollar, '$');
...
/*can-view-parser@3.5.0-pre.0#can-view-parser*/
...
/*can-reflect@1.2.5#reflections/helpers*/
...
/*can-reflect@1.2.5#reflections/type/type*/
...
/*can-reflect@1.2.5#reflections/call/call*/
...
/*can-reflect@1.2.5#reflections/get-set/get-set*/
...
/*can-reflect@1.2.5#reflections/observe/observe*/
...
/*can-reflect@1.2.5#reflections/shape/shape*/
