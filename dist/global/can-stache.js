...
/*can-view-parser@3.2.0#can-view-parser*/
define('can-view-parser', function (require, exports, module) {
    ...
    var alphaNumeric = 'A-Za-z0-9', alphaNumericHU = '-:_' + alphaNumeric, camelCase = /([a-z])([A-Z])/g, defaultMagicStart = '{{', endTag = new RegExp('^<\\/([' + alphaNumericHU + ']+)[^>]*>'), defaultMagicMatch = new RegExp('\\{\\{(![\\s\\S]*?!|[\\s\\S]*?)\\}\\}\\}?', 'g'), space = /\s/, spacesRegex = /\s/g, alphaRegex = new RegExp('[' + alphaNumeric + ']');
...
/*can-view-live@3.1.0-pre.2#lib/core*/
...
/*can-view-live@3.1.0-pre.2#lib/attr*/
...
/*can-view-live@3.1.0-pre.2#lib/attrs*/
...
/*can-view-live@3.1.0-pre.2#lib/html*/
...
/*can-view-live@3.1.0-pre.2#lib/util/runInOrder*/
...
/*can-view-live@3.1.0-pre.2#lib/list*/
...
/*can-view-live@3.1.0-pre.2#lib/text*/
...
/*can-stache@3.1.0-pre.1#helpers/core*/
...
/*can-stache@3.1.0-pre.1#src/expression*/
...
/*can-stache@3.1.0-pre.1#src/mustache_core*/
...
/*can-stache@3.1.0-pre.1#src/html_section*/
...
/*can-stache@3.1.0-pre.1#src/text_section*/
...
/*can-stache@3.1.0-pre.1#helpers/converter*/
...
/*can-stache@3.1.0-pre.1#src/intermediate_and_imports*/
...
/*can-stache@3.1.0-pre.1#can-stache*/
